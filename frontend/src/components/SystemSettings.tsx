        ...
        <form onSubmit={handleIntervalChange} className="space-y-4 max-w-md">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="w-32 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-foreground"
              />
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="px-3 py-1 text-xs font-medium text-foreground bg-accent hover:bg-accent hover:text-accent-foreground rounded-md transition-colors"
            >
              5s (Fast)
            </button>
            <button
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mb-4">
          Configure system logging settings and categories. For log viewing and management, visit the <a href="/logs" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">Log Management</a> page.
        </p>
        ...
        <form onSubmit={handleConfigSave} className="space-y-6 max-w-2xl">
          ...
          <div className="space-y-3">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="file-logging" className="ml-2 block text-sm text-foreground">
                Enable File Logging
              </label>
            </div>
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
              />
              <label htmlFor="json-logging" className="ml-2 block text-sm text-foreground">
              ...
              {Object.entries(loggingConfig.categories).map(([category, enabled]) => (
                <div key={category} className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label htmlFor={`category-${category}`} className="ml-2 block text-sm text-foreground capitalize">
                    {category}
                  </label>
                </div>
              ))}
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className="flex items-center px-3 py-1 text-xs font-medium text-foreground bg-accent hover:bg-accent hover:text-accent-foreground rounded-md transition-colors disabled:opacity-50"
            >
